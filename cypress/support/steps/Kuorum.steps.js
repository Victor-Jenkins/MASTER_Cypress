...
const elements1 = {
  ...
  madridButton: () => cy.get('body > div.page-wrapper.overflow > div.main-wrapper > section > div > div > div > div.hero-2-right.max-width-large > a'),
  ...
  name: () => cy.get('#Nombre-4'),
  email: () => cy.get('#Email-7'),
